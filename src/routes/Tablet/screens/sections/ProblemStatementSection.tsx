...
const problemCards = [
  {
    icon: "https://c.animaapp.com/mjyvgvc4Hn2SIG/img/frame-47.svg",
  ...
  {
    icon: "https://c.animaapp.com/mjyvgvc4Hn2SIG/img/frame-50.svg",
    title: "Refund Bottleneck",
    description:
      "At move-out, teams waste time chasing renter info and defending charges, slowing refunds.",
  },
  {
    icon: "https://c.animaapp.com/mjyvgvc4Hn2SIG/img/frame-49.svg",
...
export const ProblemStatementSection = (): JSX.Element => {
  ...
  return (
    <section className="relative w-full bg-[#161616] overflow-hidden">
      <div className="flex flex-col w-full items-center justify-center gap-[63px] px-[30px] py-[88px] xl:py-[85px]">
        <div className="flex flex-col items-center gap-[13px] w-full opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:200ms]">
          ...
          <p className="flex items-center justify-center w-full max-w-[822px] h-24 font-body font-[number:var(--body-font-weight)] text-white text-[length:var(--body-font-size)] text-center tracking-[var(--body-letter-spacing)] leading-[var(--body-line-height)] [font-style:var(--body-font-style)]">
