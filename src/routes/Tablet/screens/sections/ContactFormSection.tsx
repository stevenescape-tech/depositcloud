...
export const ContactFormSection = (): JSX.Element => {
  ...
  return (
    <section id="contact" className="relative w-full bg-[#161616] overflow-hidden scroll-mt-20">
      <Separator className="bg-[#51b0ff] h-[0.5px]" />

      <div className="flex flex-col items-center justify-center w-full px-[30px] pt-14 xl:pt-[85px] pb-14 xl:pb-[85px]">
