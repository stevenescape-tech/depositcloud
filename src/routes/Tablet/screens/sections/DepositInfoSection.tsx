...
export const DepositInfoSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-3 px-0 py-14 w-full bg-[linear-gradient(0deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.75)_100%),url(https://c.animaapp.com/mk4ukvevAaIUXO/img/section---deposit-platform.png)_50%_50%_/_cover]">
