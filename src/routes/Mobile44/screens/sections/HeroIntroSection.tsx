    ...
    <section className="flex flex-col w-full items-center gap-7 relative">
      <div className="flex flex-col max-w-screen-md items-center gap-6 relative w-full">
        <div className="flex flex-col w-full items-center gap-3.5 relative">
          ...
          <div className="flex flex-col items-center relative w-full translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
        ...
        <div className="w-full items-center flex flex-col translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:400ms]">
          <p className="relative [font-family:'Courier_Prime',Helvetica] font-normal text-white text-base text-center tracking-[0] leading-7 max-w-[301px]">
      ...
      <Separator className="w-full bg-[url(https://c.animaapp.com/mk4ukvevAaIUXO/img/divider.svg)] h-px bg-[100%_100%] translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms]" />
    </section>
  );
};
