    ...
    <div className="flex flex-col items-center relative bg-white overflow-hidden w-full">
      ...
      <section className="relative w-full overflow-hidden">
        <img
          ...
          alt="Background"
          src="https://c.animaapp.com/mlmpqe9tsgQxxy/img/-dsc1222-1.png"
        />
      ...
      <section className="flex flex-col w-full items-center gap-3 pt-7 pb-[22px] px-0 relative bg-[linear-gradient(0deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.75)_100%),url(https://c.animaapp.com/mlmpqe9tsgQxxy/img/section---deposit-platform.png)] bg-center bg-cover">
