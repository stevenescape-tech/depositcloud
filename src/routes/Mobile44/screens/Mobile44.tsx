...
export const Mobile44 = (): JSX.Element => {
  return (
    <div className="flex flex-col items-center relative bg-white overflow-hidden w-full">
      ...
      <section className="flex flex-col w-full items-center gap-3 pt-7 pb-[22px] px-0 relative bg-[linear-gradient(0deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.75)_100%),url(/img/section---deposit-platform.png)] bg-center bg-cover">
