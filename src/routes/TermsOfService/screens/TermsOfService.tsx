    ...
    <div className="flex flex-col min-h-screen items-center relative bg-white overflow-hidden">
      ...
      <main id="main-content" className="flex-col justify-center gap-2.5 pt-[100px] pb-0 px-4 self-stretch w-full flex items-center">
        <article className="w-full max-w-[1128px] font-body font-[number:var(--body-font-weight)] text-black text-[14px] tracking-[var(--body-letter-spacing)] leading-[var(--body-line-height)] [font-style:var(--body-font-style)]">
          ...
          <p className="mb-4">Last Updated: January 2nd, 2026</p>
          ...
          <h3 className="font-bold text-lg mb-2">(b) Opting Out of Arbitration Agreement.</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-lg mb-2">(c) Dispute-Resolution Process.</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-lg mb-2">(d) Equitable Relief.</h3>
          <p className="mb-4">
          ...
          <h3 className="font-bold text-lg mb-2">(e) Severability.</h3>
          <p className="mb-4">
          ...
          <h2 className="font-bold text-xl mb-2 mt-6">Class Action/Jury Trial Waiver</h2>
          <p className="mb-4">
