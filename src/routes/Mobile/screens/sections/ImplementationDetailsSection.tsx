...
export const ImplementationDetailsSection = (): JSX.Element => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url(https://c.animaapp.com/mk4ukvevAaIUXO/img/section---implement.png)",
      }}
    >
      <div className="flex flex-col items-center justify-center gap-3.5 w-full max-w-[303px]">
        <div className="flex flex-col items-center gap-[15px] w-full">
          ...
          <Separator className="w-full bg-[url(https://c.animaapp.com/mk4ukvevAaIUXO/img/divider.svg)] bg-[length:100%_100%] h-px" />
