...
export const HeroSection = (): JSX.Element => {
  return (
    <section className="flex flex-col min-h-screen items-center justify-center gap-[30px] px-4 relative w-full bg-[linear-gradient(0deg,rgba(0,0,0,0.70)_0%,rgba(0,0,0,0.70)_100%),url(https://c.animaapp.com/mlmpqe9tsgQxxy/img/hero.png)] bg-cover bg-center bg-fixed bg-no-repeat">
