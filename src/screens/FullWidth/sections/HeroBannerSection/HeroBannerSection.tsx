...
export const HeroBannerSection = (): JSX.Element => {
  return (
    <section className="flex flex-col min-h-screen items-center justify-center gap-[85px] py-[255px] px-4 relative w-full bg-[linear-gradient(0deg,rgba(0,0,0,0.70)_0%,rgba(0,0,0,0.70)_100%),url(https://c.animaapp.com/mjyhvu36aqUy0x/img/hero.png)] bg-cover bg-center bg-fixed bg-no-repeat" aria-label="Hero section">
