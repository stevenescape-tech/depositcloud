    ...
    export const ProblemStatementSection = (): JSX.Element => {
      ...
      return (
        <section role="region" aria-labelledby="problem-heading" className="relative w-screen bg-[#161616] overflow-hidden">
          <div className="flex flex-col w-full max-w-[1112px] mx-auto items-center justify-center gap-[63px] px-4 py-[88px] xl:py-[85px]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-[21px] w-full">
              {problemCards.map((card, index) => (
                ...
                >
                  <CardContent className="flex flex-col items-start gap-6 p-12 h-full">
