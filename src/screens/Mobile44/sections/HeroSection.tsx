...
export const HeroSection = (): JSX.Element => {
  return (
    <section 
      className="relative flex flex-col min-h-screen items-center justify-center gap-8 px-4 w-full overflow-hidden bg-[url(/img/hero.png)] bg-cover bg-center bg-no-repeat"
