export const MainHeaderSection = (): JSX.Element => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[100] flex flex-col w-full items-center justify-center gap-[11px] bg-[linear-gradient(0deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.75)_100%),url(https://c.animaapp.com/mk4ukvevAaIUXO/img/header.png)] bg-cover bg-center backdrop-blur-[2.0px] backdrop-brightness-[110%] [-webkit-backdrop-filter:blur(2.0px)_brightness(110%)] py-4 border-b-[0.5px] border-[#51b0ff]">
