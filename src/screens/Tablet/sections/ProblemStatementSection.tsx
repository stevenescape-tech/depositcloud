...
export const ProblemStatementSection = (): JSX.Element => {
  return (
    <section className="relative w-full bg-[#161616] overflow-hidden">
      <div className="flex flex-col items-center justify-center gap-[21px] pt-[59px] pb-[33px] px-[37px] max-w-[768px] mx-auto">
        <header className="flex flex-col items-center w-full">
          <h2 className="relative w-full mt-[-1.00px] [font-family:'Helvetica-Bold',Helvetica] font-bold text-white text-[32px] text-center tracking-[-1.92px] leading-[normal]">
            The way deposits are managed today doesn&apos;t work.
          </h2>

          <p className="relative flex items-center justify-center w-full h-[88px] [font-family:'Courier_Prime',Helvetica] font-normal text-white text-xs text-center tracking-[0] leading-7">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[21px] w-full mt-[21px]">
