...
export const DepositInfoSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-center gap-3 px-0 py-14 w-full bg-[linear-gradient(0deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.75)_100%),url(https://c.animaapp.com/mk4ukvevAaIUXO/img/section---deposit-platform.png)] bg-center bg-cover">
      <div className="inline-flex flex-col items-start gap-3">
        <div className="flex flex-col w-[694px] items-center gap-7">
          ...
          <div className="w-[695px] h-px bg-[url(https://c.animaapp.com/mk4ukvevAaIUXO/img/divider-2.svg)] bg-[100%_100%]" />
        </div>
