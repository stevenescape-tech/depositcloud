...
export const ValueDeliverySection = (): JSX.Element => {
  ...
  return (
    <section id="features" role="region" aria-labelledby="features-heading" className="relative w-full flex items-center justify-center px-6 py-7 md:px-[30px] md:py-12 xl:px-4 xl:py-[85px]">
      <div className="absolute inset-0 bg-[url(/img/features.png)] bg-cover bg-center bg-fixed" />
      ...
      <div className="relative z-10 flex flex-col w-full xl:max-w-[1112px] items-center gap-[26px]">
        ...
        <h2 id="features-heading" className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms] text-center max-w-[942px] font-h2 font-[number:var(--h2-font-weight)] text-white text-[28px] tracking-[-1.68px] md:text-[length:var(--h2-font-size)] md:tracking-[var(--h2-letter-spacing)] leading-[var(--h2-line-height)] [font-style:var(--h2-font-style)]">
