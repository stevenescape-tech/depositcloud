  ...
  return (
    <>
      <header role="banner" className="fixed top-0 left-0 right-0 z-[10002] flex flex-col w-full items-center justify-center gap-[11px] bg-[linear-gradient(0deg,rgba(0,0,0,0.75)_0%,rgba(0,0,0,0.75)_100%),url(https://c.animaapp.com/mjyhvu36aqUy0x/img/header.png)] bg-cover bg-center py-4 border-b-[0.5px] border-b-[#51b0ff] border-l-0 border-r-0 border-t-0">
        ...
        <nav className="hidden md:flex xl:hidden w-full max-w-[694px] mx-auto px-4 items-center justify-between translate-y-[-1rem] animate-fade-in opacity-0">
          <button
            onClick={handleLogoClick}
            className="cursor-pointer bg-transparent border-0 p-0 focus:outline-2 focus:outline-offset-2 focus:outline-white"
            aria-label={variant === 'legal' ? 'Return to homepage' : 'Return to top of page'}
