  ...
  ({ category, title, description, features, footer, animationDelay }, ref) => {
    return (
      <Card
        ...
        className="relative flex flex-col items-start gap-4 p-7 md:p-12 bg-black/40 border border-solid border-brand-blue shadow-[inset_0_1px_0_rgba(255,255,255,0.06),inset_0_-1px_0_rgba(255,255,255,0.02),0_8px_32px_rgba(0,0,0,0.35)] [-webkit-backdrop-filter:blur(24px)_saturate(180%)_brightness(105%)] [backdrop-filter:blur(24px)_saturate(180%)_brightness(105%)] overflow-hidden hover:bg-black/50 hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-1px_0_rgba(255,255,255,0.03),0_8px_40px_rgba(0,0,0,0.4)] transition-all duration-300"
      >
